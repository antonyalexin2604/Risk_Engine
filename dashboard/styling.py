...
def apply_global_styling():
    """
    Apply refined, institutional light-theme styling to the PROMETHEUS dashboard.

    Palette: cream (#fafaf8) background · white cards · slate-900 headings ·
             slate-500/600 body text · crimson accent · JetBrains Mono numbers.

    Usage in app.py (MUST be called before st.set_page_config):
    ...
    <style>
        ...
        /* Prevent heavy overrides from leaking into custom HTML components */
        span, div { font-weight: inherit !important; }

        /* ── Headings ── */
        h1 { color: #0f172a !important; font-weight: 400 !important; font-size: 1.75rem !important; line-height: 1.15 !important; }
        h2 { color: #0f172a !important; font-weight: 500 !important; font-size: 1.35rem !important; line-height: 1.20 !important; }
        ...
        /* ── Spinner ── */
        .stSpinner > div { border-top-color: #991b1b !important; }
    </style>
