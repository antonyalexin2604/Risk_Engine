#!/usr/bin/env python3
"""Convert IMM_TECHNICAL_GUIDE.md to IMM_TECHNICAL_GUIDE.docx"""
...
SRC  = os.path.join(BASE, 'docs', 'IMM_TECHNICAL_GUIDE.md')
DST  = os.path.join(BASE, 'docs', 'IMM_TECHNICAL_GUIDE.docx')
